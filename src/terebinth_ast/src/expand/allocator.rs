use terebinth_macros::HashStable_Generic;
...
pub fn alloc_error_handler_name(alloc_error_handler_kind: AllocatorKind) -> &'static str {
    match alloc_error_handler_kind {
        AllocatorKind::Global => "__tg_oom",
        AllocatorKind::Default => "__tdl_oom",
    }
}

pub const NO_ALLOC_SHIM_IS_UNSTABLE: &str = "__terebinth_no_alloc_shim_is_unstable";
